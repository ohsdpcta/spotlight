...
Route::prefix('/user')->group(function(){
    ...
    Route::prefix('/{id}')->group(function(){
        ...
        Route::get('followlist', 'FollowerController@followlist')->middleware('auth');
        Route::get('followerlist', 'FollowerController@followerlist')->middleware('auth');
...
// 以下編集画面のルート-------------------------------------------------------------------------------
        ...
        Route::prefix('/summary')->group(function(){
            ...
            Route::get('account/delete', 'UserController@delete')->middleware('auth');
            Route::post('account/delete', 'UserController@remove')->middleware('auth');
            ...
            Route::get('sample/{sample_id}/edit', 'SampleController@edit')->middleware('auth');//編集画面
            Route::post('sample/{sample_id}/edit', 'SampleController@update')->middleware('auth');//編集するぜ！
